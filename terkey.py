...
class Terkey:
  ...
  def banner(self):
      ...
      print(f'{a}Author Rahardiyan'.center(53))
  ...
  def about(self):
    ...
    A program from {a}Rahardiyan{c} for you.
    ...
    * Facebook  : {a}https://www.facebook.com/profile.php?id=100082331747595{c}
    * WhatsApp : {a}https://wa.me/62882008211320{c}
